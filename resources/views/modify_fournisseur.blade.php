                                        ...
                                        <div class="card-body">
                                            ...
                                            <form  action="{{ url('modify_fournisseur')}}/{{ $fournisseur->fournisseur_id }}" method="GET">
                                                ...
                                                <div class="form-group"><label>Prénom</label>
                                                    <input class="form-control"  value="{{ $fournisseur->prenom }}" type="text" placeholder="prénom" name="prenom" required>
                                                </div>
                                                <div class="form-group"><label>Adresse</label>
                                                    <input class="form-control" type="text"  value="{{ $fournisseur->adresse }}" placeholder="Adresse" name="adresse">
                                                </div>
                                                ...
                                                <div class="row" style="margin-bottom: 10px;">
                                                    <div class="col-lg-6">
                                                       ...
                                                       <input class="form-control"  value="{{ $fournisseur->telephone }}" type="text" placeholder="telephone" name="telephone">
                                                    </div>

                                                    <div class="col-lg-6">
                                                        <label>Email</label>
                                                        <input class="form-control" type="text"  value="{{ $fournisseur->email }}" placeholder="email" name="email">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row" style="margin-bottom: 30px;">
                                                    <div class="col-lg-6">
                                                        ...
                                                        <input class="form-control" type="text" placeholder="Code postal" name="code_postal"  value="{{ $fournisseur->code_postal }}">
                                                    </div>
                                                ...
                                                <div class="row" style="margin-bottom: 30px;">
                                                    <div class="col-lg-6">
                                                        <label>ICE</label>
                                                        <input class="form-control" type="text"  value="{{ $fournisseur->ice }}" placeholder="ICE" name="ice"> 
                                                    </div>

                                                    <div class="col-lg-6">
                                                        <label>IF</label>
                                                        <input class="form-control"  value="{{ $fournisseur->if }}" type="text" placeholder="IF" name="if">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row" style="margin-bottom: 30px;">
                                                    <div class="col-lg-6">
                                                        <label>Patente</label>
                                                        <input class="form-control" type="text"  value="{{ $fournisseur->patente }}" placeholder="Patente" name="patente">
                                                    </div>

                                                    <div class="col-lg-6">
                                                        <label>CNSS</label>
                                                        <input class="form-control"  value="{{ $fournisseur->cnss }}" type="text" placeholder="CNSS" name="cnss">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row" style="margin-bottom: 30px;">
                                                    <div class="col-lg-6">
                                                        <label>RC</label>
                                                        <input class="form-control" type="text"  value="{{ $fournisseur->rc }}" placeholder="RC" name="rc">
                                                    </div>
                                                </div>
