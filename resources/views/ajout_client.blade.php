                      ...
                      <ul>
                        ...
                        <li class="has_sub"><a target="_self" href="javascript:void(0);" class="waves-effect"><i class="dripicons-document"></i> <span>Clients </span><span class="menu-arrow float-right"><i class="mdi mdi-chevron-right"></i></span></a>
                            <ul class="list-unstyled">
                                <li><a target="_self"  href="{{ url('/ajout_client') }}">Ajouter un client/prospect</a></li>
                            ...
                            <div class="col-9">
                                ...
                                <div class="card m-b-10" style="width: 100%">
                                    <div class="card-body">
                                        ...
                                        <form action="#">
                                            <div class="form-group"><label>Statut</label> <select class="custom-select"><option selected="selected">Choisir un status</option><option value="1">Client</option><option value="2">Prospect</option></select></div>
                                            <div class="form-group"><label>Civilité</label> <select class="custom-select"><option selected="selected">Choisir une civilité</option><option value="1">One</option><option value="2">Two</option><option value="3">Three</option></select></div>
                                            <div class="form-group"><label for="example-text-input" >Raison sociale</label>
                                            ...
                                            <select class="custom-select"><option selected="selected">Choisir un réglement</option><option value="1">réglement</option><option value="2">réglement</option></select>     
                                            </div>
                                            
                                            <div class="col-lg-6">
                                            <label>Tarif par défaut</label>
                                            <select class="custom-select"><option selected="selected">Choisir un tarif</option><option value="1">tarif</option><option value="2">tarif</option></select>       
                                             </div>
                                            </div>
                                            ...
                                            <center>
                                            <button type="button" class="btn btn-outline-success waves-effect waves-light">Valider&nbsp;&nbsp;&nbsp;&nbsp;<i class="mdi mdi-account-check-outline"></i></button>
                                            </center>
