            ...
            <div class="content">
                ...
                <div class="page-content-wrapper">
                    <div class="container-fluid">
                        <form id="form" action="{{ url('/create_avoir') }}" method="post" enctype="multipart/form-data">
                        {{ csrf_field() }}
                                ...
                                <div class="card m-b-10" style="width: 100%">
                                    <div class="card-body">
                                        ...
                                        <div class="row" style="margin-bottom: 30px;">
                                            ...
                                            <div class="col-lg-6">
                                                <label>Numéro</label>
                                                <input id="numero" name="numero" class="form-control" type="text" value="A-{{$y}}-{{$idFact+1}}" readOnly>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row" style="margin-bottom: 30px;">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group"><label>Remboursement</label>
                                                    <div>
                                                        <div class="input-group">
                                                            <input id="remb" name="remb" class="form-control" type="text"  >
                                           
                                                        <div class="input-group-append bg-custom b-0"></div>
                                                        </div>
                                                        <div class="col">
                                                        <input id="date_remb" name="date_remb" class="form-control" type="text" value="{{$today}}" readOnly >
                                                        </div>
                                                        <!-- input-group -->
                                                    </div>
                                                </div>
