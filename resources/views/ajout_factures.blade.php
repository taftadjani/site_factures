            ...
            <div class="content">
                ...
                <div class="page-content-wrapper">
                    <div class="container-fluid">
                        <form id="form" action="{{ url('/create_facture') }}" method="post" enctype="multipart/form-data">
                        {{ csrf_field() }}
                                ...
                                <div class="card m-b-10" style="width: 100%">
                                    <div class="card-body">
                                        ...
                                        <div class="row" style="margin-bottom: 30px;">
                                            ...
                                            <div class="col-lg-6">
                                                <label>Numéro</label>
                                                <input id="numero" name="numero" class="form-control" type="text" value="F-{{$y}}-{{$idFact+1}}" readOnly>
                                            </div>
                                        </div>
