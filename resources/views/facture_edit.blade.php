            ...
            <div class="content">
                ...
                <div class="page-content-wrapper">
                    <div class="container-fluid">
                        <form id="form" action="{{ url('/modif_facture') }}" method="post" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        @foreach($facture as $fact)
                            <div class="table-wrapper">
                                <div class="card m-b-10" style="width: 100%">
                                    <div class="card-body">
                                    <input name="idfacture" id="idfacture" class="form-control" type="text" value="{{$fact->facture_id}}" hidden readOnly  />
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group"><label>Payée</label>
                                                    <div>
                                                        ...
                                                        <div class="col">
                                                        <input id="date_payement" name="date_payement" class="form-control" type="text" value="{{$fact->date_paiement}}" readOnly >
                                                        </div>
                                                        <!-- input-group -->
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group"><label>Tarif du document</label>
                                                    <div>
                                                        ...
                                                        <?php
                                                             ...
                                                             $prod_fact = DB::table("facture_produits")
                                                             ->where("facture_id",$fact->facture_id)
                                                             ->select('facture_produits.*')
                                                             ->get();
                                            ...
                                            <thead>
                                                ...
                                                <tr> 
                                                    ...
                                                    @foreach($product as $cc)
                                                     ...
                                                     <input class="form-control" id="id_prod_fact{{$j}}" name="id_prod_fact{{$j}}" type="text"  value="{{$pf->facture_produit_id}}" hidden>
