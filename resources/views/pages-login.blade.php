...
<body class="fixed-left">
    ...
    <!-- Begin page -->
    <div class="home-btn d-none d-sm-block"><a target="_self"   href="{{ url('/') }}" class="text-dark"><i class="mdi mdi-home h1"></i></a></div>
    <div class="account-pages">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <div>
                        <div><a target="_self"   href="{{ url('/') }}" class="logo logo-admin"><img src="images/logo_dark.png" height="28" alt="logo"></a></div>
                            ...
                            <div class="p-2">
                                <form class="form-horizontal m-t-20" action="{{ url('/') }}">
                                    <div class="form-group row">
                                        <div class="col-12"><input class="form-control" type="text" required="" placeholder="Username"></div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group m-t-10 mb-0 row">
                                        <div class="col-sm-7 m-t-20"><a  target="_self"  href="pages-recoverpw.html" class="text-muted"><i class="mdi mdi-lock"></i> Forgot your password?</a></div>
                                        <div class="col-sm-5 m-t-20"><a  target="_self"  href="pages-register.html" class="text-muted"><i class="mdi mdi-account-circle"></i> Create an account</a></div>
                                    </div>
                                </form>
                            </div>
                        </div>
