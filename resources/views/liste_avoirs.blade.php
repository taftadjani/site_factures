...
<head>
    ...
    <title>Listes des avoirs - Proxima</title>
                                    ...
                                    @foreach($client as $c)
                                        <tr>
                                            ...
                                            <div class="table-data-feature" style="justify-content: flex-start">
                                                ...
                                                &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                                                <a class="item" data-toggle="tooltip" data-placement="top" id="{{$fact->avoir_id}}" name="factid" href='/code_edit_av?idFacture={{$fact->avoir_id}}&&idClient={{$c->client_id}}' class="btn btn-xs btn-info pull-right">
                                                <i class="fas fa-pencil-alt"></i>
                                           
                                                </a>
                                               
                                                &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                                                <a class="item" data-toggle="tooltip" data-placement="top" id="{{$fact->avoir_id}}" name="factid" href='/code_delete_av?idFacture={{$fact->avoir_id}}&&idClient={{$c->client_id}}' class="btn btn-xs btn-info pull-right">
