...
<head>
    ...
    <title>Listes des BL - Proxima</title>
                                    ...
                                    @foreach($client as $c)
                                        <tr>
                                            ...
                                            <div class="table-data-feature" style="justify-content: flex-start">
                                               ...
                                               <a class="item" data-toggle="tooltip" data-placement="top" id="{{$fact->bon_livraison_id}}" name="factid" href='/extrasBl?idFacture={{$fact->bon_livraison_id}}&&idClient={{$c->client_id}}&&type={{$bl}}' class="btn btn-xs btn-info pull-right">
                                               ...
                                               &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; 
                                            <a class="item" data-toggle="tooltip" data-placement="top" id="{{$fact->bon_livraison_id}}" name="factidc" href='/extrasBl?idFacture={{$fact->bon_livraison_id}}&&idClient={{$c->client_id}}&&type={{$fz}}' class="btn btn-xs btn-info pull-right">
                                            <i class="fa fa-bars"></i>
                                                        </a>
                                            
                                                        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                                                <a class="item" data-toggle="tooltip" data-placement="top" id="{{$fact->bon_livraison_id}}" name="factid" href='/code_edit_bl?idFacture={{$fact->bon_livraison_id}}&&idClient={{$c->client_id}}&&type={{$fz}}' class="btn btn-xs btn-info pull-right">
                                                <i class="fas fa-pencil-alt"></i>
                                           
                                                </a>
                                               
                                                &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                                                <a class="item" data-toggle="tooltip" data-placement="top" id="{{$fact->bon_livraison_id}}" name="factid" href='/code_delete_bl?idFacture={{$fact->bon_livraison_id}}&&idClient={{$c->client_id}}&&type={{$fz}}' class="btn btn-xs btn-info pull-right">
