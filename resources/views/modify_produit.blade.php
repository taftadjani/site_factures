                                ...
                                <div class="container-fluid">
                                    <div class="card m-b-10" style="width: 100%">
                                        ...
                                        <form action="{{ url('modify_produit')}}/{{ $produit->produit_id }}" method="PUT|PATCH">
                                                ...
                                                rows="3">{{ $produit->designation }}</textarea>
                                                </div>
                                                <div class="row">
                                                    <div class="col-lg-6">
                                                        <label>Référence produit</label>
                                                        <input class="form-control" type="text" placeholder="Référence produit" name="reference_produit" value='{{ $produit->reference }}'
                                                            id="example-text-input" required>
                                                    </div>
                                                    <div class="col-lg-6">
                                                        <label>Quantité en stock</label>
                                                        <input class="form-control" type="number" name="quantite" placeholder="Quantité en stock(0 default)" value="{{ $produit->quantite_stock }}"
                                                    ...
                                                    <div class="col-lg-6">
                                                        ...
                                                        <select class="custom-select" name="famille">
                                                            ...
                                                            @foreach ($familles as $famille)
                                                                ...
                                                                <option value="{{ $famille->famille_id }}" selected="selected">{{ $famille->libelle }}</option>
                                                    ...
                                                    <div class="col-lg-6">
                                                        ...
                                                        <select class="custom-select" name="fournisseur">
                                                            ...
                                                            @if ($produit->fournisseur_id == $fournisseur->fournisseur_id )
                                                                ...
                                                                <option value="{{ $fournisseur->fournisseur_id }}" selected="selected">{{ $fournisseur->nom }} {{ $fournisseur->prenom }}</option>    
                                                                @else
                                                     ...
                                                     <div class="col-lg-6">
                                                        ...
                                                        <select class="custom-select" name="unite">
                                                            ...
                                                            @foreach ($unites as $unite)
                                                                ...
                                                                <option selected="selected"  value="{{ $unite->unite_id }}">{{ $unite->libelle }}</option>
                                                                @else
                                                ...
                                                <div class="row" style="margin-bottom: 30px;">
                                                    <div class="col-lg-6">
                                                        ...
                                                        <input class="form-control" type="number" name="prix_achat" placeholder="Prix D'achat" required value = "{{ $produit->prix_achat }}">
                                                    </div>

                                                    <div class="col-lg-6">
                                                        <label>Prix Vente</label>
                                                        <input class="form-control" type="number" placeholder="Prix Vente" value = "{{ $produit->prix_vente }}" name="prix_vente" required>
                                                    </div>
                                                    ...
                                                    <div class="col-lg-6">
                                                        ...
                                                        <select class="custom-select" name="taxe">
                                                            ...
                                                            @foreach ($taxes as $taxe)
                                                                ...
                                                                <option  selected="selected"  value="{{ $taxe->taxe_id }}">{{ $taxe->libelle }}</option>
                                                                @else
                                                     ...
                                                     <div class="col-lg-6">
                                                        ...
                                                        <input class="form-control" type="number" placeholder="Marge HT" name="marge_ht" value = "{{ $produit->marge_ht }}">
                                                    </div>
                                                </div>
