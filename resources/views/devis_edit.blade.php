                        ...
                        @foreach($facture as $fact)
                            <div class="table-wrapper">
                                <div class="card m-b-10" style="width: 100%">
                                    <div class="card-body">
                                    <input name="idfacture" id="idfacture" class="form-control" type="text" value="{{$fact->devis_id}}" hidden readOnly  />
                                        ...
                                        <div class="row" style="margin-bottom: 30px;">
                                            ...
                                            <div class="form-group"><label>Acceptation</label>
                                                    <div>
                                                        <div class="input-group">
                                                            ...
                                                            <option selected="selected"  value="{{$fact->acceptation}}" disabled >{{$fact->acceptation}}</option>
                                            ...
                                            <div class="form-group"><label>Date Acceptation</label>
                                                    <div>
                                                        <div class="input-group">
                                                        <input id="date_acceptation" name="date_acceptation" class="form-control" type="text" value="{{$fact->date_acceptation}}"  readOnly>
                                        ...
                                        <div class="row" style="margin-bottom: 30px;">
                                            <div class="col-lg-6">
                                                <div class="form-group"><label>Date Echéance</label>
                                                    <div>
                                                        <div class="input-group"><input name="date_validite" type="text" class="form-control" value="{{$fact->date_validite}}" id="datepicker-multiple-date">
                                                            <div class="input-group-append bg-custom b-0"><span class="input-group-text"><i class="mdi mdi-calendar"></i></span></div>
                                                        </div>
                                                        <!-- input-group -->
                                                    </div>
                                            ...
                                            <thead>
                                                ...
                                                <tr> 
                                                    ...
                                                    @foreach($product as $cc)
                                                     ...
                                                     <input class="form-control" id="id_prod_fact{{$j}}" name="id_prod_fact{{$j}}" type="text"  value="{{$pf->devis_produit_id}}" hidden>
