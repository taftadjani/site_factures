            ...
            <div class="content">
                ...
                <div class="page-content-wrapper">
                    <div class="container-fluid">
                        <form id="form" action="{{ url('/modif_bl') }}" method="post" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        @foreach($facture as $fact)
                            <div class="table-wrapper">
                                <div class="card m-b-10" style="width: 100%">
                                    <div class="card-body">
                                    <input name="idfacture" id="idfacture" class="form-control" type="text" value="{{$fact->bon_livraison_id}}" hidden readOnly  />
                                        ...
                                        <?php
                                                             ...
                                                             $prod_fact = DB::table("bon_livraison_produits")
                                                             ->where("bon_livraison_id",$fact->bon_livraison_id)
                                                             ->select('bon_livraison_produits.*')
                                                             ->get();
                                        ...
                                        <div class="row" style="margin-bottom: 30px;">
                                            <div class="col-lg-6">
                                                <div class="form-group"><label>Date Echéance</label>
                                                    <div>
                                                        <div class="input-group"><input name="date_validite" type="text" class="form-control" placeholder="jj/mm/aa" id="datepicker-multiple-date">
                                                            <div class="input-group-append bg-custom b-0"><span class="input-group-text"><i class="mdi mdi-calendar"></i></span></div>
                                                        </div>
                                                        <!-- input-group -->
                                                    </div>
                                        ...
                                        <div class="row" style="margin-bottom: 30px;">
                                            <div class="col-lg-6">
                                                <label>Acompte  </label>
                                                <input name="acompte" id="acompte" class="form-control" type="text" value="{{$fact->acompte}}" />
                                            </div>

                                            <div class="col-lg-6">
                                                <label>Net à payer </label>
                                                <input name="netApayer" id="netApayer" class="form-control" type="text" value="{{$fact->net_a_payer}}">
                                            </div>
                                        </div>
                                            ...
                                            <thead>
                                                ...
                                                <tr> 
                                                    ...
                                                    @foreach($product as $cc)
                                                     ...
                                                     <input class="form-control" id="id_prod_fact{{$j}}" name="id_prod_fact{{$j}}" type="text"  value="{{$pf->bon_livraison_produit_id}}" hidden>
