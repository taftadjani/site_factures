            ...
            <div class="content">
                ...
                <div class="page-content-wrapper">
                    <div class="container-fluid">
                        <form id="form" action="{{ url('/modif_avoir') }}" method="post" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        @foreach($facture as $fact)
                            <div class="table-wrapper">
                                <div class="card m-b-10" style="width: 100%">
                                    <div class="card-body">
                                    <input name="idfacture" id="idfacture" class="form-control" type="text" value="{{$fact->avoir_id}}" hidden readOnly  />
                                        ...
                                        <div class="form-group"><label>Nom Client</label> 
                                            ...
                                            <option selected="selected"  velue="{{$cle->client_id}}" disabled >{{$cle->prenom}} {{$cle->nom}}</option>
                                        ...
                                        <div class="row" style="margin-bottom: 30px;">
                                            ...
                                            <div class="col-lg-6">
                                                <label>Numéro</label>
                                                <input id="numero" name="numero" class="form-control" type="text" value="{{$fact->numero}}" readOnly>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row" style="margin-bottom: 30px;">
                                            <div class="col-lg-6">
                                                <div class="form-group"><label>Date Création</label>
                                                    <div>
                                                        <div class="input-group"><input name="date_creation"  type="text" class="form-control" value="{{$fact->date_creation}}"  id="datepicker-autoclose">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group"><label>Date Fermeture</label>
                                                    <div>
                                                        <div class="input-group"><input name="date_fermeture" type="text" class="form-control" value="{{$fact->date_fermeture}}" id="datepicker">
                                        ...
                                        <div class="row" style="margin-bottom: 30px;">
                                            <div class="col-lg-6">
                                                <div class="form-group"><label>Date Echéance</label>
                                                    <div>
                                                        <div class="input-group"><input name="date_validite" type="text" class="form-control" value="{{$fact->date_echeance}}" id="datepicker-multiple-date">
                                                            <div class="input-group-append bg-custom b-0"><span class="input-group-text"><i class="mdi mdi-calendar"></i></span></div>
                                                        </div>
                                                        <!-- input-group -->
                                                    </div>
                                                ...
                                                <div class="form-group"><label>Imprimé</label>
                                                    <div>
                                                        <div class="input-group">
                                                            ...
                                                            <option value="{{$fact->impression}}" selected disabled>{{$fact->impression}}</option>
                                                        ...
                                                        <?php $today=date("Y-n-j");  ?>
                                                            <input name="date_impression" id="date_impression" class="form-control" type="text" value="{{$fact->date_impression}}" readOnly >
                                        ...
                                        <div class="row" style="margin-bottom: 30px;">
                                            <div class="col-lg-6">
                                                <div class="form-group"><label>Envoi</label>
                                                    <div>
                                                        ...
                                                        <div class="col">
                                                        <input id="date_envoi" name="date_envoi" class="form-control" type="text" value="{{$fact->date_envoi}}}" readOnly >
                                                        </div>
                                                        <!-- input-group -->
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group"><label>Remboursement</label>
                                                    <div>
                                                        <div class="input-group">
                                                            <input id="remb" name="remb" class="form-control" type="text" value='{{$fact->remboursement}}' >
                                           
                                                        <div class="input-group-append bg-custom b-0"></div>
                                                        </div>
                                                        <div class="col">
                                                        <input id="date_remb" name="date_remb" class="form-control" type="text" value="{{$fact->date_remboursement}}" readOnly >
                                                        </div>
                                                        <!-- input-group -->
                                                    </div>
                                                </div>
                                        ...
                                        <div class="row" style="margin-bottom: 30px;">
                                            <div class="col-lg-6">
                                                <div class="form-group"><label>Paiement par défaut</label>
                                                    <div>
                                                        <div class="input-group">
                                                            <select class="form-control" id="payement_par_defaut" name="payement_par_defaut" required>
                                                            <option value="{{$fact->paiement}}" selected disabled>{{$fact->paiement}}</option>
                                                ...
                                                <div class="form-group"><label>Tarif du document</label>
                                                    <div>
                                                        ...
                                                        <?php
                                                             ...
                                                             $prod_fact = DB::table("avoir_produits")
                                                             ->where("avoir_id",$fact->avoir_id)
                                                             ->select('avoir_produits.*')
                                                             ->get();
                                        ...
                                        <div class="row" style="margin-bottom: 30px;">
                                            ...
                                            <div class="col-lg-6">
                                                <label>Remise(%)</label>
                                                <div class="col">
                                                    <input class="form-control" id="remiseTotal" name="remiseTotal" type="text" onkeypress="javascript:NumOnly(this.value)" onpaste="javascript:return false" value="{{$fact->remise_globale}}" >
                                                </div>
                                                ...
                                                <div class="form-group"><label>Condition de paiement</label>
                                                    <div>
                                                        ...
                                                        @foreach($condit as $condit)
                                                            <option value='{{$condit->condition_paiement_id}}' selected disabled> {{$condit->texte}}</option>
                                        ...
                                        <div class="row" style="margin-bottom: 30px;">
                                            <div class="col-lg-6">
                                                ...
                                                <textarea name="observation" id="observation"   class="form-control" maxlength="225" rows="3"  >{{$fact->annotation}}</textarea>
                                            </div>

                                            <div class="col-lg-6">
                                                <label>Annotations</label>
                                                <textarea name="annotation" id="annotation" class="form-control" maxlength="225" rows="3" >{{$fact->observation}}</textarea>
                                            </div>
                                        </div>
                                ...
                                <div class="table-wrapper">
                                    <div class="table-title">
                                        ...
                                        <table id="facture_table" name="facture_table" class="table table-bordered">
                                            <thead>
                                                ...
                                                <tr> 
                                                    ...
                                                    <select name='prodj{{$j}}' id='prodj{{$j}}' class="form-control " onchange="javascript:hij('{{$j}}')" required  >
                                                    @foreach($product as $cc)
                                                        <option selected="selected" value="{{$cc->produit_id}}" disabled> {{$cc->designation}}</option>
                                                     ...
                                                     <input class="form-control" id="id_prod_fact{{$j}}" name="id_prod_fact{{$j}}" type="text"  value="{{$pf->avoir_produit_id}}" hidden>
                                                    ...
                                                    <td>
                                                    <input id='puj{{$j}}' name='puj{{$j}}' class="form-control" type="text" value="{{$cc->prix_vente}}" readOnly >
                                                    </td>
                                                    <td>
                                                        <input id='qtej{{$j}}' name='qtej{{$j}}' class="form-control" type="text"  onkeypress="javascript:NumOnly(this.value)" onpaste="javascript:return false" onkeyup="javascript:calculHtj('{{$j}}')" value="{{$pf->quantite}}"  >
                                                    </td>
                                                    <td>
                                                        <input id="remisej{{$j}}" name="remisej{{$j}}" class="form-control"  type="text"  onkeypress="javascript:NumOnly(this.value)" onpaste="javascript:return false" onkeyup="javascript:calculRemisej('{{$j}}')" value="{{$pf->remise}}"   >
                                                    </td>
                                                    <td>
                                                        
                                                         <select name='activitej{{$j}}' id='activitej{{$j}}' class="form-control "  required>
                                                            <option selected="selected" value="{{$cc->activite}}" disabled>{{$pf->activite}}</option>
                                                    ...
                                                    <?php
                                                        ...
                                                        $r=$t-(($t * $pf->remise)/100);
                                                    ?>
                                                    <input id="totalHTj{{$j}}" name="totalHT{{$j}}" class="form-control" type="text" value="{{$r}}" readOnly  >
                                                    </td>
                                                    <td>
                                        ...
                                        <input id="nblp" name="nblp" class="form-control" type="text"  value="<?php echo count($prod_fact) ?>" hidden >
